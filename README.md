...
本项目以成都七中的校园文化为灵感，用 3D 粒子系统把**银杏树、校园标志性建筑（亭子、墨池）、校徽**等代表性元素重构为可交互的视觉幻境。作品基于 Processing Python Mode 编写。
...
> 以上为三阶段精华 GIF 预览；完整演示视频（720p，约 45 MB，含声音）见 [docs/demo.mp4](docs/demo.mp4)。
